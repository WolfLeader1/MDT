    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('http://erp-emsmdt/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('http://erp-emsmdt/close', JSON.stringify({}));
        },
        logOff() {
            $.post('http://erp-emsmdt/logOff', JSON.stringify({}));
        },
        logIn() {
            $.post('http://erp-emsmdt/logIn', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('http://erp-emsmdt/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('http://erp-emsmdt/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('http://erp-emsmdt/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('http://erp-emsmdt/performReportSearch', JSON.stringify({
        ...
        BoloSearch() {
            if (this.bolo_search) {
                ...
                $.post('http://erp-emsmdt/performBoloSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('http://erp-emsmdt/submitNewReport', JSON.stringify({
        ...
        SubmitNewBolo() {
            if (this.report_new.title && this.report_new.incident) {
                $.post('http://erp-emsmdt/submitNewBolo', JSON.stringify({
                    title: this.report_new.title,
                    incident: this.report_new.incident
                }));
        ...
        OpenOffenderDetailsById(id) {
            $.post('http://erp-emsmdt/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        ToggleBoloEdit() {
            if (this.bolo_edit.enable) {
                ...
                this.bolo_edit.data.title = this.bolo_selected.title;
                this.bolo_edit.data.incident = this.bolo_selected.incident;
            }
            return;
        },
        DeleteSelectedReport() {
            $.post('http://erp-emsmdt/deleteReport', JSON.stringify({
        ...
        DeleteSelectedBolo() {
            $.post('http://erp-emsmdt/deleteBolo', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('http://erp-emsmdt/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        SaveBoloEditChanges() {
            $.post('http://erp-emsmdt/saveBoloChanges', JSON.stringify({
                id: this.bolo_selected.id,
                title: this.bolo_edit.data.title,
                incident: this.bolo_edit.data.incident
            }));
        
            this.bolo_selected.title = this.bolo_edit.data.title;
            this.bolo_selected.incident = this.bolo_edit.data.incident;
            this.ToggleBoloEdit();
            return;
        },
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('http://erp-emsmdt/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('http://erp-emsmdt/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('http://erp-emsmdt/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('http://erp-emsmdt/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('http://erp-emsmdt/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('http://erp-emsmdt/sentencePlayer', JSON.stringify({
