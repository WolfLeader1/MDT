...
AddEventHandler('envyrp:playerSpawned', function(sentData)
    PlayerData = sentData 
...
AddEventHandler("mdt:toggleVisibilty", function(reports, warrants, officer, switch)
...
RegisterNetEvent("mdt:offduty")
AddEventHandler("mdt:offduty", function(officer)
    if officer then
...
RegisterNUICallback("logOff", function(data, cb)
    TriggerServerEvent('erp-mdt:switchDuty')
    cb('ok')
end)
...
RegisterNUICallback("performBoloSearch", function(data, cb)
    TriggerServerEvent("mdt:performBoloSearch", data.query)
    cb('ok')
end)
...
RegisterNUICallback("unimpoundMofoka", function(data, cb)
    TriggerServerEvent("mdt:unimpoundMofoka", data.plate)
    cb('ok')
end)
...
RegisterNUICallback("saveBoloChanges", function(data, cb)
    TriggerServerEvent("mdt:saveBoloChanges", data)
    cb('ok')
end)
...
RegisterNetEvent("mdt:returnBoloSearchResults")
AddEventHandler("mdt:returnBoloSearchResults", function(results)
    SendNUIMessage({
...
AddEventHandler("mdt:completedBoloAction", function()
    SendNUIMessage({
